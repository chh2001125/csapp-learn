...
bool need_regids =
	f_icode in { IRRMOVQ, IOPQ, IPUSHQ, IPOPQ, 
		     IIRMOVQ, IRMMOVQ, IMRMOVQ,IIADDQ }; ## insert IADDQ 
# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IJXX, ICALL,IIADDQ }; ## insert IADDQ

# Predict next value of PC
word f_predPC = [
	f_icode in { IJXX, ICALL } && (f_valC >= f_valP) : f_valC;
	1 : f_valP;
];
...
word d_srcB = [
	D_icode in { IOPQ, IRMMOVQ, IMRMOVQ,IIADDQ  } : D_rB; ## insert IADDQ
...
word d_dstE = [
	D_icode in { IRRMOVQ, IIRMOVQ, IOPQ,IIADDQ} : D_rB; ## insert IADDQ
	D_icode in { IPUSHQ, IPOPQ, ICALL, IRET } : RRSP;
...
word aluA = [
	...
	E_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ,IIADDQ } : E_valC; ## insert IADDQ
...
word aluB = [
	E_icode in { IRMMOVQ, IMRMOVQ, IOPQ, ICALL, 
		     IPUSHQ, IRET, IPOPQ,IIADDQ } : E_valB; ## insert IADDQ
...
bool set_cc = (E_icode == IOPQ || E_icode == IIADDQ)  && ## insert IADDQ
